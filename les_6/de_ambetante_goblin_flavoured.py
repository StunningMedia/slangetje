...
def ambetante_goblin(wachtwoord):
    ...
    match lengte_wachtwoord:
        case 1 | 2 | 3 | 4 | 5:
            print("Welk een erudiete poging, O gij toonbeeld der intelligentie!")
        case num if num in range(6, 11):
            print(wachtwoord_poging * lengte_wachtwoord)
        case _:
            print('Gij denken gij zijn slim gij?  Denk nog maar keer, gij poephoofd gij!')
    return True
